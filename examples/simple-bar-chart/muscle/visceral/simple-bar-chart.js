  ...
  var WelcomeView = Section.View.extend({
    ...
    createChart: function() {
      var pizzaCollection = window.pizzaCollection = new PizzaCollection([
        { name: 'California', amount: Math.floor(Math.random() * 250) },
        { name: 'Chicago', amount: Math.floor(Math.random() * 250) },
        { name: 'Greek', amount: Math.floor(Math.random() * 250) },
        { name: 'Hawaiian', amount: Math.floor(Math.random() * 250) },
        { name: 'NY', amount: Math.floor(Math.random() * 250) },
        { name: 'Quad City', amount: Math.floor(Math.random() * 250) },
        { name: 'Sicilian', amount: Math.floor(Math.random() * 250) },
        { name: 'St. Louis', amount: Math.floor(Math.random() * 250) },
        { name: 'St. Louis', amount: Math.floor(Math.random() * 250) },
        { name: 'Tomato', amount: Math.floor(Math.random() * 250) }
      ]);
    ...
    addPizza: function() {
      $.ajax({
        ...
        success: function(data) {
          window.pizzaCollection.add({ name: data.results[0].user.name.first, amount: Math.floor(Math.random() * 250) });
        }
      });
    }
  });
